...
var title =flags.get(obj['countryCode']) +' '+ Area_check(obj['country']) +' '+ obj['countryCode'];
var subtitle = obj['regionName'] +' '+ City_ValidCheck(obj['city']) +' '+ ISP_ValidCheck(obj['org']);
var ip = obj['query'];
var description = "状态:" + obj['status'] +'\n'+ "国家:" + Area_check(obj['country']) +'\n'+ "国家代码:" + obj['countryCode'] +'\n'+ "省份:" + obj['regionName'] +'\n'+ "省份代码:"+ obj['region'] +'\n'+ "城市:" + City_ValidCheck(obj['regionName']) +'\n'+ "邮编:" + obj['zip'] +'\n'+ "地理坐标:" + "经度" + obj['lon'] +","+ "纬度" + obj['lat'] +'\n'+ "时区:" + obj['timezone'] +'\n'+ "服务商:" + obj['isp'] +'\n'+ "数据中心:" + obj['org'] +'\n'+ "自治系统号:" + obj['as'] +'\n'+ "IP:" + obj['query'];
